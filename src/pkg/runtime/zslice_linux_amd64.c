...
#line 15 "/opt/godir/go.stormgbs/src/pkg/runtime/slice.goc"
enum 
{ 
debug = 0 
} ; 
#line 20 "/opt/godir/go.stormgbs/src/pkg/runtime/slice.goc"
...
runtime·makeslice(SliceType* t, int64 len, int64 cap, Slice ret)
{
	...
	ret.cap = 0;
	FLUSH(&ret);
#line 24 "/opt/godir/go.stormgbs/src/pkg/runtime/slice.goc"
...
#line 48 "/opt/godir/go.stormgbs/src/pkg/runtime/slice.goc"
uintptr runtime·zerobase; 
#line 50 "/opt/godir/go.stormgbs/src/pkg/runtime/slice.goc"
static void 
...
runtime·growslice(SliceType* t, Slice old, int64 n, Slice ret)
{
	...
	ret.cap = 0;
	FLUSH(&ret);
#line 59 "/opt/godir/go.stormgbs/src/pkg/runtime/slice.goc"
...
#line 86 "/opt/godir/go.stormgbs/src/pkg/runtime/slice.goc"
static void 
...
int32 flag; 
Type *typ; 
#line 94 "/opt/godir/go.stormgbs/src/pkg/runtime/slice.goc"
typ = t->elem; 
if ( typ->size == 0 ) { 
*ret = x; 
ret->cap = newcap; 
...
#line 101 "/opt/godir/go.stormgbs/src/pkg/runtime/slice.goc"
newcap1 = x.cap; 
#line 107 "/opt/godir/go.stormgbs/src/pkg/runtime/slice.goc"
...
#line 118 "/opt/godir/go.stormgbs/src/pkg/runtime/slice.goc"
if ( newcap1 > MaxMem/typ->size ) 
runtime·panicstring ( "growslice: cap out of range" ) ; 
capmem = runtime·roundupsize ( newcap1*typ->size ) ; 
flag = 0; 
#line 123 "/opt/godir/go.stormgbs/src/pkg/runtime/slice.goc"
...
runtime·copy(Slice to, Slice fm, uintptr width, intgo ret)
{
	ret = 0;
	FLUSH(&ret);
#line 135 "/opt/godir/go.stormgbs/src/pkg/runtime/slice.goc"
...
runtime·slicestringcopy(Slice to, String fm, intgo ret)
{
	ret = 0;
	FLUSH(&ret);
#line 175 "/opt/godir/go.stormgbs/src/pkg/runtime/slice.goc"
...
{
#line 197 "/opt/godir/go.stormgbs/src/pkg/runtime/slice.goc"

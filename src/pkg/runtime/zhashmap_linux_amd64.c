...
#line 15 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
enum 
{ 
docheck = 0 , 
debug = 0 , 
...
bool eq; 
byte *k , *v; 
#line 33 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
cnt = 0; 
#line 36 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
...
#line 59 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
if ( h->oldbuckets != nil ) { 
...
#line 84 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
if ( cnt != h->count ) { 
runtime·printf ( "%D %D\n" , ( uint64 ) cnt , ( uint64 ) h->count ) ; 
runtime·throw ( "entries missing" ) ; 
} 
} 
#line 90 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
static void 
...
uint8 flags; 
#line 98 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
flags = 0; 
#line 101 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
keysize = t->key->size; 
...
#line 119 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
...
#line 135 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
B = 0; 
while ( hint > BUCKETSIZE && hint > LOAD * ( ( uintptr ) 1 << B ) ) 
B++; 
#line 141 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
if ( checkgc ) mstats.next_gc = mstats.heap_alloc; 
if ( B == 0 ) { 
#line 144 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
buckets = nil; 
} else { 
buckets = runtime·cnewarray ( t->bucket , ( uintptr ) 1 << B ) ; 
} 
#line 150 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
h->count = 0; 
h->B = B; 
h->flags = flags; 
h->keysize = keysize; 
...
#line 167 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
static void 
...
uint8 top; 
bool eq; 
#line 182 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
b = ( Bucket* ) ( h->oldbuckets + oldbucket * h->bucketsize ) ; 
newbit = ( uintptr ) 1 << ( h->B - 1 ) ; 
#line 185 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
if ( !evacuated ( b ) ) { 
#line 189 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
...
#line 209 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
hash = h->hash0; 
t->key->alg->hash ( &hash , t->key->size , IK ( h , k ) ) ; 
if ( ( h->flags & Iterator ) != 0 ) { 
t->key->alg->equal ( &eq , t->key->size , IK ( h , k ) , IK ( h , k ) ) ; 
if ( !eq ) { 
#line 225 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
if ( ( top & 1 ) != 0 ) 
hash |= newbit; 
else 
hash &= ~newbit; 
...
#line 235 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
if ( ( hash & newbit ) == 0 ) { 
...
#line 290 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
...
#line 298 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
if ( oldbucket == h->nevacuate ) { 
h->nevacuate = oldbucket + 1; 
if ( oldbucket + 1 == newbit ) 
#line 302 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
h->oldbuckets = nil; 
} 
if ( docheck ) 
check ( t , h ) ; 
} 
#line 308 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
static void 
grow_work ( MapType *t , Hmap *h , uintptr bucket ) 
{ 
uintptr noldbuckets; 
#line 313 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
noldbuckets = ( uintptr ) 1 << ( h->B - 1 ) ; 
#line 317 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
evacuate ( t , h , bucket & ( noldbuckets - 1 ) ) ; 
#line 320 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
if ( h->oldbuckets != nil ) 
evacuate ( t , h , h->nevacuate ) ; 
} 
#line 324 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
static void 
...
byte *new_buckets; 
uint8 flags; 
#line 332 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
if ( h->oldbuckets != nil ) 
...
if ( ( h->flags & Iterator ) != 0 ) 
flags |= OldIterator; 
#line 342 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
h->B++; 
h->flags = flags; 
h->oldbuckets = old_buckets; 
h->buckets = new_buckets; 
h->nevacuate = 0; 
#line 350 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
if ( docheck ) 
check ( t , h ) ; 
} 
#line 356 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
static byte* 
...
bool eq; 
byte *k , *k2 , *v; 
#line 368 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
key = *keyp; 
if ( docheck ) 
check ( t , h ) ; 
if ( h->count == 0 ) 
...
#line 474 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
static void 
...
byte *k , *v; 
byte *kmem , *vmem; 
#line 489 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
if ( docheck ) 
check ( t , h ) ; 
hash = h->hash0; 
t->key->alg->hash ( &hash , t->key->size , key ) ; 
...
#line 496 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
again: 
bucket = hash & ( ( ( uintptr ) 1 << h->B ) - 1 ) ; 
if ( h->oldbuckets != nil ) 
...
if ( !eq ) 
continue; 
#line 521 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
...
#line 533 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
if ( h->count >= LOAD * ( ( uintptr ) 1 << h->B ) && h->count >= BUCKETSIZE ) { 
hash_grow ( t , h ) ; 
goto again; 
} 
#line 538 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
if ( inserti == nil ) { 
#line 540 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
if ( checkgc ) mstats.next_gc = mstats.heap_alloc; 
...
#line 549 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
if ( ( h->flags & IndirectKey ) != 0 ) { 
if ( checkgc ) mstats.next_gc = mstats.heap_alloc; 
...
#line 569 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
static void 
...
byte *k , *v; 
bool eq; 
#line 580 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
if ( docheck ) 
check ( t , h ) ; 
if ( h->count == 0 ) 
return; 
...
if ( !eq ) 
continue; 
#line 601 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
if ( ( h->flags & IndirectKey ) != 0 ) { 
* ( byte** ) k = nil; 
} else { 
...
#line 612 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
b->tophash[i] = Empty; 
h->count--; 
#line 617 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
if ( docheck ) 
check ( t , h ) ; 
return; 
} 
...
#line 631 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
static void 
hash_iter_init ( MapType *t , Hmap *h , Hiter *it ) 
{ 
uint32 old; 
#line 636 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
if ( sizeof ( Hiter ) / sizeof ( uintptr ) != 10 ) { 
runtime·throw ( "hash_iter size incorrect" ) ; 
} 
it->t = t; 
it->h = h; 
#line 643 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
it->B = h->B; 
it->buckets = h->buckets; 
#line 647 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
it->bucket = 0; 
it->offset = runtime·fastrand1 ( ) & ( BUCKETSIZE - 1 ) ; 
it->done = false; 
it->bptr = nil; 
#line 654 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
for ( ;; ) { 
old = h->flags; 
...
#line 662 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
if ( h->buckets == nil ) { 
#line 665 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
it->done = true; 
} 
} 
#line 671 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
static void 
hash_next ( Hiter *it ) 
{ 
Hmap *h; 
...
byte *k , *v; 
byte *rk , *rv; 
#line 685 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
h = it->h; 
t = it->t; 
bucket = it->bucket; 
b = it->bptr; 
...
#line 692 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
next: 
if ( b == nil ) { 
if ( it->done ) { 
#line 696 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
it->key = nil; 
it->value = nil; 
return; 
} 
if ( h->oldbuckets != nil && it->B == h->B ) { 
#line 705 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
...
if ( check_bucket >= 0 ) { 
#line 737 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
t->key->alg->equal ( &eq , t->key->size , IK ( h , k ) , IK ( h , k ) ) ; 
if ( eq ) { 
#line 741 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
hash = h->hash0; 
t->key->alg->hash ( &hash , t->key->size , IK ( h , k ) ) ; 
...
#line 754 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
...
#line 761 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
it->key = IK ( h , k ) ; 
it->value = IV ( h , v ) ; 
} else { 
#line 766 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
t->key->alg->equal ( &eq , t->key->size , IK ( h , k ) , IK ( h , k ) ) ; 
if ( eq ) { 
#line 773 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
rk = IK ( h , k ) ; 
...
#line 784 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
it->key = IK ( h , k ) ; 
it->value = IV ( h , v ) ; 
} 
} 
...
reflect·ismapkey(Type* typ, bool ret)
{
	ret = 0;
	FLUSH(&ret);
#line 804 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"

	ret = typ != nil && typ->alg->hash != runtime·nohash;
	FLUSH(&ret);
}

#line 808 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
static Hmap* 
makemap_c ( MapType *typ , int64 hint ) 
{ 
Hmap *h; 
Type *key; 
#line 814 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
key = typ->key; 
#line 816 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
if ( sizeof ( Hmap ) > 48 ) 
runtime·panicstring ( "hmap too large" ) ; 
#line 819 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
if ( hint < 0 || ( int32 ) hint != hint ) 
runtime·panicstring ( "makemap: size out of range" ) ; 
#line 822 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
if ( key->alg->hash == runtime·nohash ) 
runtime·throw ( "runtime.makemap: unsupported map key type" ) ; 
#line 825 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
h = runtime·cnew ( typ->hmap ) ; 
hash_init ( typ , h , hint ) ; 
#line 831 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
if ( debug ) { 
runtime·printf ( "makemap: map=%p; keysize=%p; valsize=%p; keyalg=%p; valalg=%p\n" , 
h , key->size , typ->elem->size , key->alg , typ->elem->alg ) ; 
} 
#line 836 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
return h; 
} 
void
runtime·makemap(MapType* typ, int64 hint, Hmap* ret)
{
	ret = 0;
	FLUSH(&ret);
#line 839 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
...
reflect·makemap(MapType* t, Hmap* ret)
{
	ret = 0;
	FLUSH(&ret);
#line 843 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
...
runtime·mapaccess1(MapType* t, Hmap* h, byte* key, byte* val)
{
	val = 0;
	FLUSH(&val);
#line 850 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
...
runtime·mapaccess2(MapType* t, Hmap* h, byte* key, byte* val, bool pres)
{
	...
	pres = 0;
	FLUSH(&pres);
#line 877 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
...
reflect·mapaccess(MapType* t, Hmap* h, byte* key, byte* val)
{
	val = 0;
	FLUSH(&val);
#line 910 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
...
{
#line 923 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
...
{
#line 947 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
...
{
#line 968 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
...
{
#line 991 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
...
{
#line 1010 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
...
reflect·mapiterinit(MapType* t, Hmap* h, Hiter* it)
{
	it = 0;
	FLUSH(&it);
#line 1038 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
...
{
#line 1044 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
...
{
#line 1058 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
...
reflect·mapiterkey(Hiter* it, byte* key)
{
	key = 0;
	FLUSH(&key);
#line 1062 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
...
reflect·maplen(Hmap* h, intgo len)
{
	len = 0;
	FLUSH(&len);
#line 1067 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
...
#line 1078 "/opt/godir/go.stormgbs/src/pkg/runtime/hashmap.goc"
